                                    ...
                                    match Self::process_sample_static(
                                        ...
                                        Ok(new_detections) => {
                                            ...
                                            for detection in &new_detections {
                                                let class_name = if detection.class_id
                                                    < COCO_NAMES.len() as i32
                                                {
                                            ...
                                            if let Ok(mut detections_guard) =
                                                detections_clone.lock()
                                            {
...
pub fn run_visual_demo() -> Result<()> {
    ...
    println!(
        "Starting visual YOLO demo with bounding boxes on {}",
        config.input.source
    );
